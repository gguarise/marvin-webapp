...
export class AtendimentoService extends BaseService {
  ...
  putAgendar(payload: any): Observable<any> {
    return this.http.put(`${this.atendimentoUrl}agendar`, payload).pipe(
      map((ent) => {
        if (ent) {
          return ent;
        }
  ...
  putCancelar(payload: any): Observable<any> {
    return this.http.put(`${this.atendimentoUrl}cancelar`, payload).pipe(
      map((ent) => {
        if (ent) {
          return ent;
        }
  ...
  putFinalizar(payload: any): Observable<any> {
    return this.http.put(`${this.atendimentoUrl}finalizar`, payload).pipe(
      map((ent) => {
        if (ent) {
          return ent;
        }
  ...
  putDesfinalizar(payload: any): Observable<any> {
    return this.http.put(`${this.atendimentoUrl}desfinalizar`, payload).pipe(
      map((ent) => {
        if (ent) {
          return ent;
        }
